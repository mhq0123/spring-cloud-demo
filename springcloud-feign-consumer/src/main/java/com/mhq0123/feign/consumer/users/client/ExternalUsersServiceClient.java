...
import com.mhq0123.feign.consumer.users.hystrix.ExternalUsersServiceClientHystrix;
 ...
 */
@FeignClient(value = "springcloud-service-external-users", fallback = ExternalUsersServiceClientHystrix.class)
public interface ExternalUsersServiceClient {

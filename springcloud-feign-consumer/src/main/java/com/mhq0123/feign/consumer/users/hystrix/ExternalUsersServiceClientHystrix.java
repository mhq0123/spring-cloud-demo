 ...
 */
@Component // 容器管理
public class ExternalUsersServiceClientHystrix implements ExternalUsersServiceClient{

    private final static Logger logger = LoggerFactory.getLogger(ExternalUsersServiceClientHystrix.class);
